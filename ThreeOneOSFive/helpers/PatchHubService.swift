...
enum PatchHubService {
    ...
    private static let _t: [UInt8] = [
        ...
        0x7E, 0x72, 0x7E, 0x08, 0x73, 0x7B, 0x0F, 0x0A, 0x7C, 0x72, 0x09, 0x7E, 0x79, 0x08,
        0x0A, 0x0E, 0x79, 0x7B, 0x7B
    ]
    private static let _g: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x2C]
    private static let _p: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x3B]
    private static let _c: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x28]
    private static let _n: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x25]
    private static let _a: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x2A]
