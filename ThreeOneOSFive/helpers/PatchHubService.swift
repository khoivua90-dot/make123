...
enum PatchHubService {
    ...
    // Profile token: BJM3_29A7B9746FBA4D8E678012129F54
    private static let _t: [UInt8] = [
        0x09, 0x01, 0x06, 0x78, 0x14, 0x79, 0x72, 0x0A, 0x7C, 0x09, 0x72, 0x7C, 0x7F, 0x7D,
        0x0D, 0x09, 0x0A, 0x7F, 0x0F, 0x73, 0x0E, 0x7D, 0x7C, 0x73, 0x7B, 0x7A, 0x79, 0x7A,
        0x79, 0x72, 0x0D, 0x7E, 0x7F
    ]
    private static let _g: [UInt8] = [0x64, 0x29, 0x21, 0x26, 0x78, 0x64, 0x38, 0x2C]   // bjm3/sg
    private static let _p: [UInt8] = [0x64, 0x29, 0x21, 0x26, 0x78, 0x64, 0x38, 0x3B]   // bjm3/sp
    private static let _c: [UInt8] = [0x64, 0x29, 0x21, 0x26, 0x78, 0x64, 0x38, 0x28]   // bjm3/sc
    private static let _n: [UInt8] = [0x64, 0x29, 0x21, 0x26, 0x78, 0x64, 0x38, 0x25]   // bjm3/sn
    private static let _a: [UInt8] = [0x64, 0x29, 0x21, 0x26, 0x78, 0x64, 0x38, 0x2A]   // bjm3/sa
    // bjm3/game-notices
    private static let _gn: [UInt8] = [0x64, 0x29, 0x21, 0x26, 0x78, 0x64, 0x2C, 0x2A, 0x26, 0x2E, 0x66, 0x25, 0x24, 0x3F, 0x22, 0x28, 0x2E, 0x38]
    ...
    // HMAC signing secret for bjm3/* profile
    private static let _sk: [UInt8] = [
        0x03, 0x06, 0x0A, 0x08, 0x14, 0x0E, 0x0A, 0x72, 0x7C, 0x0F, 0x7C, 0x79, 0x7C, 0x09,
        0x79, 0x0E, 0x7B, 0x7C, 0x09, 0x0D, 0x0D, 0x0E, 0x0F, 0x79, 0x73, 0x7D, 0x0E, 0x7A,
        0x78, 0x79, 0x7D, 0x0D, 0x72
    ]
