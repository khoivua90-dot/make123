...
enum PatchHubService {
    ...
    // Content token: WMD3_01F7A8DF41CA896FB63123487834
    private static let _t: [UInt8] = [
        0x1C, 0x06, 0x0F, 0x78, 0x14, 0x7B, 0x7A, 0x0D, 0x7C, 0x0A, 0x73, 0x0F, 0x0D, 0x7F,
        0x7A, 0x08, 0x0A, 0x73, 0x72, 0x7D, 0x0D, 0x09, 0x7D, 0x78, 0x7A, 0x79, 0x78, 0x7F,
        0x73, 0x7C, 0x73, 0x78, 0x7F
    ]
    ...
    // HMAC_66E2B13F1AD54D440F8E4D1761D7
    private static let _hk: [UInt8] = [
    ...
    static var hmacKey: String { d(_hk) }
    ...
    private static func get(_ url: URL) -> URLRequest {
        ...
        r.setValue(hmacKey, forHTTPHeaderField: "X-Hmac-Key")
