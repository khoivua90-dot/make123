...
enum PatchHubService {
    ...
    private static let _t: [UInt8] = [
        0x2F, 0x38, 0x3C, 0x27, 0x22, 0x29, 0x14, 0x7C, 0x03, 0x33, 0x79, 0x25, 0x06, 0x72,
        0x39, 0x1A, 0x7F, 0x3B, 0x1D, 0x7A, 0x3C, 0x09, 0x7D, 0x14, 0x18, 0x0E, 0x08, 0x1E,
        0x19, 0x0E, 0x79, 0x7B, 0x79, 0x7D
    ]
    private static let _g: [UInt8] = [0x28, 0x3D, 0x64, 0x2C, 0x26]
