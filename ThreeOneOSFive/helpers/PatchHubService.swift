...
enum PatchHubService {
    ...
    // Profile token: UGT4_59D15C4CBF2073BA2C2CFBAD29C6
    private static let _t: [UInt8] = [
        0x1E, 0x0C, 0x1F, 0x7F, 0x14, 0x7E, 0x72, 0x0F, 0x7A, 0x7E, 0x08, 0x7F, 0x08, 0x09,
        0x0D, 0x79, 0x7B, 0x7C, 0x78, 0x09, 0x0A, 0x79, 0x08, 0x79, 0x08, 0x0D, 0x09, 0x0A,
        0x0F, 0x79, 0x72, 0x08, 0x7D
    ]
    private static let _g: [UInt8] = [0x64, 0x3E, 0x2C, 0x3F, 0x7F, 0x64, 0x38, 0x2C]   // ugt4/sg
    private static let _p: [UInt8] = [0x64, 0x3E, 0x2C, 0x3F, 0x7F, 0x64, 0x38, 0x3B]   // ugt4/sp
    private static let _c: [UInt8] = [0x64, 0x3E, 0x2C, 0x3F, 0x7F, 0x64, 0x38, 0x28]   // ugt4/sc
    private static let _n: [UInt8] = [0x64, 0x3E, 0x2C, 0x3F, 0x7F, 0x64, 0x38, 0x25]   // ugt4/sn
    private static let _a: [UInt8] = [0x64, 0x3E, 0x2C, 0x3F, 0x7F, 0x64, 0x38, 0x2A]   // ugt4/sa
    // ugt4/game-notices
    private static let _gn: [UInt8] = [0x64, 0x3E, 0x2C, 0x3F, 0x7F, 0x64, 0x2C, 0x2A, 0x26, 0x2E, 0x66, 0x25, 0x24, 0x3F, 0x22, 0x28, 0x2E, 0x38]
    ...
    // HMAC signing secret for ugt4/* profile
    private static let _sk: [UInt8] = [
        0x03, 0x06, 0x0A, 0x08, 0x14, 0x7D, 0x7F, 0x0E, 0x08, 0x0E, 0x7F, 0x7E, 0x0A, 0x0A,
        0x72, 0x7E, 0x0A, 0x7C, 0x0E, 0x7A, 0x09, 0x72, 0x09, 0x0D, 0x7B, 0x0F, 0x08, 0x7B,
        0x73, 0x0D, 0x79, 0x78, 0x09
    ]
