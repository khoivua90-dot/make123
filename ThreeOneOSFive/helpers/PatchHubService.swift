...
enum PatchHubService {
    ...
    // Profile token: 5KA7_7B3FE56267E03450EFE89F7D7DC1
    private static let _t: [UInt8] = [
        0x7E, 0x00, 0x0A, 0x7C, 0x14, 0x7C, 0x09, 0x78, 0x0D, 0x0E, 0x7E, 0x7D, 0x79, 0x7D,
        0x7C, 0x0E, 0x7B, 0x78, 0x7F, 0x7E, 0x7B, 0x0E, 0x0D, 0x0E, 0x73, 0x72, 0x0D, 0x7C,
        0x0F, 0x7C, 0x0F, 0x08, 0x7A
    ]
    private static let _g: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x2C]   // 5ka7/sg
    private static let _p: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x3B]   // 5ka7/sp
    private static let _c: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x28]   // 5ka7/sc
    private static let _n: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x25]   // 5ka7/sn
    private static let _a: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x2A]   // 5ka7/sa
    // 5ka7/game-notices
    ...
    private static let _sk: [UInt8] = [
        0x03, 0x06, 0x0A, 0x08, 0x14, 0x7C, 0x73, 0x0F, 0x73, 0x7E, 0x0D, 0x72, 0x73, 0x7F,
