...
enum PatchHubService {
    ...
    // Content token: 57SV_F837ACAB145E8D095ADAB0D6950D
    private static let _t: [UInt8] = [
        0x7E, 0x7C, 0x18, 0x1D, 0x14, 0x0D, 0x73, 0x78, 0x7C, 0x0A, 0x08, 0x0A, 0x09, 0x7A,
        0x7F, 0x7E, 0x0E, 0x73, 0x0F, 0x7B, 0x72, 0x7E, 0x0A, 0x0F, 0x0A, 0x09, 0x7B, 0x0F,
        0x7D, 0x72, 0x7E, 0x7B, 0x0F
    ]
    private static let _g: [UInt8] = [0x7E, 0x7C, 0x38, 0x3D, 0x64, 0x38, 0x2C]   // 57sv/sg
    private static let _p: [UInt8] = [0x7E, 0x7C, 0x38, 0x3D, 0x64, 0x38, 0x3B]   // 57sv/sp
    private static let _c: [UInt8] = [0x7E, 0x7C, 0x38, 0x3D, 0x64, 0x38, 0x28]   // 57sv/sc
    private static let _n: [UInt8] = [0x7E, 0x7C, 0x38, 0x3D, 0x64, 0x38, 0x25]   // 57sv/sn
    private static let _a: [UInt8] = [0x7E, 0x7C, 0x38, 0x3D, 0x64, 0x38, 0x2A]   // 57sv/sa
    // api/game-notices
    ...
    // Key API token: 57SV_F837ACAB145E8D095ADAB0D6950D
    private static let _kt: [UInt8] = [
        0x7E, 0x7C, 0x18, 0x1D, 0x14, 0x0D, 0x73, 0x78, 0x7C, 0x0A, 0x08, 0x0A, 0x09, 0x7A,
        0x7F, 0x7E, 0x0E, 0x73, 0x0F, 0x7B, 0x72, 0x7E, 0x0A, 0x0F, 0x0A, 0x09, 0x7B, 0x0F,
        0x7D, 0x72, 0x7E, 0x7B, 0x0F
    ]
    // HMAC secret for key API response verification: HMAC_35B2C4335997A0DEEE3A2C0A5C79
    private static let _ksk: [UInt8] = [
        0x03, 0x06, 0x0A, 0x08, 0x14, 0x78, 0x7E, 0x09, 0x79, 0x08, 0x7F, 0x78, 0x78, 0x7E,
        0x72, 0x72, 0x7C, 0x0A, 0x7B, 0x0F, 0x0E, 0x0E, 0x0E, 0x78, 0x0A, 0x79, 0x08, 0x7B,
        0x0A, 0x7E, 0x08, 0x7C, 0x72
    ]
