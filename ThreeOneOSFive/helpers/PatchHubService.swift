...
enum PatchHubService {
    ...
    private static let _g: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x2C]
    private static let _p: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x3B]
    private static let _c: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x28]
    private static let _n: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x25]
    private static let _a: [UInt8] = [0x7E, 0x20, 0x2A, 0x7C, 0x64, 0x38, 0x2A]
