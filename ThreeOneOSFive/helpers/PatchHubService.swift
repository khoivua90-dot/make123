...
enum PatchHubService {
    ...
    // Profile token: CBYB_072DC290C595C80DA79852CAE200
    private static let _t: [UInt8] = [
        0x08, 0x09, 0x12, 0x09, 0x14, 0x7B, 0x7C, 0x79, 0x0F, 0x08, 0x79, 0x72, 0x7B, 0x08,
        0x7E, 0x72, 0x7E, 0x08, 0x73, 0x7B, 0x0F, 0x0A, 0x7C, 0x72, 0x73, 0x7E, 0x79, 0x08,
        0x0A, 0x0E, 0x79, 0x7B, 0x7B
    ]
    private static let _g: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x2C]   // cbyb/sg
    private static let _p: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x3B]   // cbyb/sp
    private static let _c: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x28]   // cbyb/sc
    private static let _n: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x25]   // cbyb/sn
    private static let _a: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x38, 0x2A]   // cbyb/sa
    // cbyb/game-notices
    private static let _gn: [UInt8] = [0x28, 0x29, 0x32, 0x29, 0x64, 0x2C, 0x2A, 0x26, 0x2E, 0x66, 0x25, 0x24, 0x3F, 0x22, 0x28, 0x2E, 0x38]
    ...
    // HMAC signing secret for cbyb/* profile (stored, not used in current signing flow)
    private static let _sk: [UInt8] = [
        0x03, 0x06, 0x0A, 0x08, 0x14, 0x0D, 0x0A, 0x7D, 0x0D, 0x0A, 0x0D, 0x7E, 0x0D, 0x08,
        0x7D, 0x7C, 0x7D, 0x7E, 0x7B, 0x73, 0x7A, 0x08, 0x0D, 0x7A, 0x08, 0x09, 0x0F, 0x7C,
        0x0E, 0x72, 0x78, 0x78, 0x0E
    ]
