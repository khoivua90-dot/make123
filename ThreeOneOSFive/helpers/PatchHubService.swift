...
enum PatchHubService {
    ...
    private static let _t: [UInt8] = [
        0x73, 0x72, 0x0D, 0x1D, 0x14, 0x0F, 0x7E, 0x73, 0x0E, 0x7E, 0x0D, 0x7E, 0x0E, 0x08,
        0x7A, 0x7D, 0x7E, 0x72, 0x0D, 0x0A, 0x78, 0x0A, 0x7B, 0x7A, 0x7D, 0x08, 0x0E, 0x7C,
        0x78, 0x0A, 0x7B, 0x0F, 0x0A
    ]
    private static let _g: [UInt8] = [0x73, 0x72, 0x2D, 0x3D, 0x64, 0x38, 0x2C]
    private static let _p: [UInt8] = [0x73, 0x72, 0x2D, 0x3D, 0x64, 0x38, 0x3B]
    private static let _c: [UInt8] = [0x73, 0x72, 0x2D, 0x3D, 0x64, 0x38, 0x28]
    private static let _n: [UInt8] = [0x73, 0x72, 0x2D, 0x3D, 0x64, 0x38, 0x25]
    private static let _a: [UInt8] = [0x73, 0x72, 0x2D, 0x3D, 0x64, 0x38, 0x2A]
    ...
    private static let _sk: [UInt8] = [
        0x03, 0x06, 0x0A, 0x08, 0x14, 0x08, 0x73, 0x0D, 0x72, 0x78, 0x72, 0x0E, 0x79, 0x7B,
        0x7D, 0x7C, 0x0A, 0x08, 0x0D, 0x7E, 0x0D, 0x78, 0x08, 0x7B, 0x7C, 0x72, 0x0F, 0x0D,
        0x7B, 0x7E, 0x78, 0x79, 0x7E
    ]
