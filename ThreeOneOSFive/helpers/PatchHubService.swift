...
enum PatchHubService {
    ...
    // Profile token: QW6N_15B371ED600514D98500C7C4AD80
    ...
    private static let _g: [UInt8] = [0x3A, 0x3C, 0x7D, 0x25, 0x64, 0x38, 0x2C]   // qw6n/sg
    private static let _p: [UInt8] = [0x3A, 0x3C, 0x7D, 0x25, 0x64, 0x38, 0x3B]   // qw6n/sp
    private static let _c: [UInt8] = [0x3A, 0x3C, 0x7D, 0x25, 0x64, 0x38, 0x28]   // qw6n/sc
    private static let _n: [UInt8] = [0x3A, 0x3C, 0x7D, 0x25, 0x64, 0x38, 0x25]   // qw6n/sn
    private static let _a: [UInt8] = [0x3A, 0x3C, 0x7D, 0x25, 0x64, 0x38, 0x2A]   // qw6n/sa
    // qw6n/game-notices
    private static let _gn: [UInt8] = [0x3A, 0x3C, 0x7D, 0x25, 0x64, 0x2C, 0x2A, 0x26, 0x2E, 0x66, 0x25, 0x24, 0x3F, 0x22, 0x28, 0x2E, 0x38]
    ...
    // HMAC signing secret for qw6n/* profile (stored, not used in current signing flow)
